...
public class TablePhysicalAssessmentCardiorespiratoryFitnessFemale {
	...
	public TablePhysicalAssessmentCardiorespiratoryFitnessFemale() {
	...
	public String verifyCardiorespiratoryFitness_Female(double r, double age) {
