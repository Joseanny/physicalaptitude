...
public class TablePhysicalAssementWaistAndHipRatioMale {
	...
	public TablePhysicalAssementWaistAndHipRatioMale() {
		initializeTableOfTabICQ_Male();
	}

	public void initializeTableOfTabICQ_Male() {
		...
		LowValue1.setMaximumValueOfTheTableCell(0.82);

		LowValue2.setLowerAgeLimite(30);
		LowValue2.setHighterAgeLimite(39);
		LowValue2.setMaximumValueOfTheTableCell(0.84);

		LowValue3.setLowerAgeLimite(40);
		LowValue3.setHighterAgeLimite(49);
		LowValue3.setMaximumValueOfTheTableCell(0.88);

		LowValue4.setLowerAgeLimite(50);
		LowValue4.setHighterAgeLimite(59);
		LowValue4.setMaximumValueOfTheTableCell(0.90);

		LowValue5.setLowerAgeLimite(60);
		LowValue5.setHighterAgeLimite(69);
		LowValue5.setMaximumValueOfTheTableCell(0.91);

		ModerateValue1.setLowerAgeLimite(20);
		ModerateValue1.setHighterAgeLimite(29);
		ModerateValue1.setMinimumValueOfTheTableCell(0.83);
		ModerateValue1.setMaximumValueOfTheTableCell(0.88);

		ModerateValue2.setLowerAgeLimite(30);
		ModerateValue2.setHighterAgeLimite(39);
		ModerateValue2.setMinimumValueOfTheTableCell(0.84);
		ModerateValue2.setMaximumValueOfTheTableCell(0.91);

		ModerateValue3.setLowerAgeLimite(40);
		ModerateValue3.setHighterAgeLimite(49);
		ModerateValue3.setMinimumValueOfTheTableCell(0.88);
		ModerateValue3.setMaximumValueOfTheTableCell(0.95);

		ModerateValue4.setLowerAgeLimite(50);
		ModerateValue4.setHighterAgeLimite(59);
		ModerateValue4.setMinimumValueOfTheTableCell(0.90);
		ModerateValue4.setMaximumValueOfTheTableCell(0.96);

		ModerateValue5.setLowerAgeLimite(60);
		ModerateValue5.setHighterAgeLimite(69);
		ModerateValue5.setMinimumValueOfTheTableCell(0.91);
		ModerateValue5.setMaximumValueOfTheTableCell(0.98);

		HighValue1.setLowerAgeLimite(20);
		HighValue1.setHighterAgeLimite(29);
		HighValue1.setMinimumValueOfTheTableCell(0.89);
		HighValue1.setMaximumValueOfTheTableCell(0.94);

		HighValue2.setLowerAgeLimite(30);
		HighValue2.setHighterAgeLimite(39);
		HighValue2.setMinimumValueOfTheTableCell(0.92);
		HighValue2.setMaximumValueOfTheTableCell(0.96);

		HighValue3.setLowerAgeLimite(40);
		HighValue3.setHighterAgeLimite(49);
		HighValue3.setMinimumValueOfTheTableCell(0.96);
		HighValue3.setMaximumValueOfTheTableCell(1.00);

		HighValue4.setLowerAgeLimite(50);
		HighValue4.setHighterAgeLimite(59);
		HighValue4.setMinimumValueOfTheTableCell(0.97);
		HighValue4.setMaximumValueOfTheTableCell(1.02);

		HighValue5.setLowerAgeLimite(60);
		HighValue5.setHighterAgeLimite(69);
		HighValue5.setMinimumValueOfTheTableCell(0.99);
		HighValue5.setMaximumValueOfTheTableCell(1.03);

		VeryHighValue1.setLowerAgeLimite(20);
		VeryHighValue1.setHighterAgeLimite(29);
		VeryHighValue1.setMinimumValueOfTheTableCell(0.95);
		...
		VeryHighValue2.setMinimumValueOfTheTableCell(0.97);
		...
		VeryHighValue3.setMinimumValueOfTheTableCell(1.01);
		...
		VeryHighValue4.setMinimumValueOfTheTableCell(1.03);
		...
		VeryHighValue5.setMinimumValueOfTheTableCell(1.04);
	...
	public String verifyWaistAndHipRatio_Male(double r, double age) {
