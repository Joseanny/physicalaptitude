...
public class SkinfoldFemaleGeneralPetroski1995 extends SkinfoldFemaleGeneral{

	double density; //densidade
	
	 public double Female_18A61years () {

        density = Math.log10(1.1954713 - 0.07513507) * (getAM() + getSI() + getCX() + getPR()) - 0.00041072 *(getAgeInYears());
