...
public class SkinfoldFemaleGeneralJacksonPollockEtWard1980 extends SkinfoldFemaleGeneral{

	double density; //densidade
	
	 public double Female_18A55years () {

        density = (1.097 - 0.00046971) * (getChestMeasure() + getAM() + getTR() + getSB() + getAB() + getSI() +
        getCX()) + ((0.00000056 * Math.pow(getChestMeasure() + getAM() + getTR() + getSB() + getAB() + getSI() + getCX(), 2)) - 0.00012828) * (getAgeInYears());
