...
public class SkinfoldMaleSpecficGuedes1985 extends SkinfoldMaleSpecfic {
	
	double density; // densidade
    
	public double UniversityStudents_17A27years() { /* Estudantes universitários 17 a 27 anos */

		density = Math.log10(1.1714 - 0.0671) * (getTR() + getSI() + getSB() + getAB()) ;
