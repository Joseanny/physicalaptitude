...
public class SkinfoldMaleGeneralPollockSchmidtEtJackson1980 extends SkinfoldMaleGeneral {
	
	double density; //densidade
	
    public double AdultMan() {

       density = ((1.10938 - 0.0008267) * (getChestMeasure() + getAB() + getCX())) + ((0.0000016 * Math.pow(getChestMeasure() + getAB() + getCX(), 2)) - 0.0002574) * (getAgeInYears());
