...
public class SkinfoldFemaleSpecficSloanEtAlii1962 extends SkinfoldFemaleSpecfic{
	
	double density; //densidade

	 public double UniversityStudents_17A25years() { /* Estudantes Universitárias de 17 a 25 anos */

	    	density /* densidade */ = ((1.0764 - 0.00081) * getSI()) - (0.00088 * getTR());
