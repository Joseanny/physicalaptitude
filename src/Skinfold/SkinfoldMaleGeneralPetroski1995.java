...
public class SkinfoldMaleGeneralPetroski1995 extends SkinfoldMaleGeneral {
	
	double density; //densidade
	
	 public double Male_18A61years () {

        density = ((1.10726863 - 0.00081201) * (getSB() + getTR() + getSI() + getPR())) + ((0.00000212 * Math.pow(getSB() + getTR() + getSI() + getPR(), 2)) - 0.00041761) * (getAgeInYears());
