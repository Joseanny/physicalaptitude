...
public class SkinfoldFemaleSpecficWilmoreEtBehnke1970 extends SkinfoldFemaleSpecfic {
	
	double density; // densidade

	public double UniversityStudents_18A48years() { /* Estudantes Universitárias de 18 a 48 anos */

		density /* densidade */ = ((1.06234 - 0.00068) * getSB()) - (0.00039 * getTR()) - (0.00025 * getCX());
