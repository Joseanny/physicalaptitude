...
public class SkinfoldFemaleGeneralDurninEtWomersley1974 extends SkinfoldFemaleGeneral{
	
	double density; //densidade
	
	public double Female_16A68years() {

        density = Math.log10(1.1567 - 0.0717) * (getTR() + getBI() + getSB() + getSI()) ;
