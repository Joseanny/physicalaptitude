...
public class SkinfoldFemaleGeneralPollockSchmidtEtJackson1980 extends SkinfoldFemaleGeneral{
	
	double density; //densidade
	
	public double AdultWomen () {

        density = ((1.0994921 - 0.0009929) * (getTR() + getSI() + getCX())) + ((0.0000023 * Math.pow(getTR() + getSI() + getCX(), 2)) - 0.0001392) * (getAgeInYears());
