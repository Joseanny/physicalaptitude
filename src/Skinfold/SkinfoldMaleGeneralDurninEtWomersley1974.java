...
public class SkinfoldMaleGeneralDurninEtWomersley1974 extends SkinfoldMaleGeneral{
	
	double density; //densidade

	public double Male_17A72years () {

    	density = Math.log10(1.1765 - 0.0744) * (getTR() + getBI() + getSB() + getSI()) ;
