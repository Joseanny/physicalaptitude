...
public class SkinfoldFemaleSpecficNagamineEtSuzuki1964 extends SkinfoldFemaleSpecfic{
	
	double density; //densidade

	 public double JapaneseNative_18A23years() { /* Japonesas nativos de 18 a 23 anos */

		 	density /* densidade */ = (1.0897 - 0.00133) * (getTR() + getSB());
