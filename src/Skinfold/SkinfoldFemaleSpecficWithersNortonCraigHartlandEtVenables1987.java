...
public class SkinfoldFemaleSpecficWithersNortonCraigHartlandEtVenables1987 extends SkinfoldFemaleSpecfic{
	
	double density; //densidade
	
	 public double ActiveWomen_17A35years() { /* Mulheres ativas de 17 a 35 anos  */

		 	density /* densidade */ =  Math.log10(1.20953 - 0.08294) * (getTR() + getSB() + getSI() + getAB() + getCX() + getPR());
