...
public class AnthropometricMaleSpecificMayhewEtAlii1981 extends AnthropometricMaleSpecific{
	
	private double density; //densidade
	
	public double MayhewEtAlii(){
		
		density = 1.1078 - 0.00071 * getAB() - 0.00112 * getPR() + 0.00057 * getPPES() - 0.00124 * getDBIC();
