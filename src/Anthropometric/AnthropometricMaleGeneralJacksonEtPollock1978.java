...
public class AnthropometricMaleGeneralJacksonEtPollock1978 extends AnthropometricMaleGeneral {
	
	private double density; //densidade
	
	public double  Male18A61years(){
		
		density /*densidade*/ = 1.101 - 0.0004115 * (getChestMeasure() + getAM() + getTR() + getSB() + getAB() +
		getSI() + getCX()) + 0.00000069 * Math.pow((getChestMeasure() + getAM() + getTR() + getSB() + getAB() +
		getSI() + getCX()), 2) - 0.00022631 * getAgeInYears() - getPCIN() + 0.0190632 * getPANT();
