...
public class AnthropometricMaleSpecificKatchEtMcArdleAtletas1973 extends AnthropometricMaleSpecific {
	
	private double density; //densidade
	
	public double MaleFight13A18years(){
		
		density = 1.12691 - 0.00357 * getPerimeterArms() - 0.00127 * getAB() + 0.00524 * getPerimeterArms();
