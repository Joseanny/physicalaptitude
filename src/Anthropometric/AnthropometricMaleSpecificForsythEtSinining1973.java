...
public class AnthropometricMaleSpecificForsythEtSinining1973 extends AnthropometricMaleSpecific {
	
	private double density;
	
	public double ForsythEtSinining(){
		
		density = 1.03523 - 0.00156 * getSB() + 0.00207 * getBitrocanterianoDiameter() - 0.0014 * getAB();
