...
public class AnthropometricFemaleSpecificKatchEtMcArdle1973 extends AnthropometricFemaleSpecific{
	
	private double density; //densidade 
	
	public double UniversityStudents(){ /* estudantes universitárias*/
		
		density /*densidade*/ = 1.14465 - 0.0015 * getPerimeterOfTheExtendedArm() - 0.00105 * getAB() + 0.00448 * getPANT() - 0.00168 * getThighPerimeter();
