...
public class ControlSkinfoldSpecificDeurenbergEtAlii1990FemalePrepubescent {
	
	SkinfoldFemaleSpecficDeurenbergEtAlii1990 obj;
	TableBodyDenstiyWoman tab4;
	
	public ControlSkinfoldSpecificDeurenbergEtAlii1990FemalePrepubescent() {
	...
	public String ReturnSituation_DeurenbergEtAlii_1990(double TR, double BI, double SI, double SB, int gender, int age) {
		...
		res = tab4.check(obj.Girls_Prepubescent(), age);
