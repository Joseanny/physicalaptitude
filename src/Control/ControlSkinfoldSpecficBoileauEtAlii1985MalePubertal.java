...
public class ControlSkinfoldSpecficBoileauEtAlii1985MalePubertal {
	
	SkinfoldMaleSpecficDeurenbergEtAlii1990 om2;
	TableBodyDenstiyMaleChildrenAndTeen tab2;
	
	public ControlSkinfoldSpecficBoileauEtAlii1985MalePubertal(){
	...
	public String ReturnSituation_BoileauEtAlii_1985_Male_Pubertal(double BI, double TR, double SB, double SI){
	       ...
	       String res = tab2.check(om2.WhiteAndBlackBoys_Pubertal());
